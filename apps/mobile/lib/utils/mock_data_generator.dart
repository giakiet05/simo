...
class MockDataGenerator {
  ...
  static const String vietinbankWalletId = '00000000-0000-4000-8000-000000000002';
  static const String momoWalletId = '00000000-0000-4000-8000-000000000003';
  static const String binanceWalletId = '00000000-0000-4000-8000-000000000004';
    ...
    for (var month in pastMonths) {
      ...
      for (var i = 0; i < incomeCount; i++) {
        ...
        final String walletId = randWallet < 0.70
            ? vietinbankWalletId
            : (randWallet < 0.90 ? binanceWalletId : defaultCashWalletId);
      ...
      for (var i = 0; i < expenseCount; i++) {
        ...
        final randWallet = _random.nextDouble();
        if (amount >= 1000000.0) {
          walletId = randWallet < 0.90 ? vietinbankWalletId : defaultCashWalletId;
        } else {
          walletId = randWallet < 0.55
              ? momoWalletId
              : (randWallet < 0.85 ? defaultCashWalletId : vietinbankWalletId);
        }
  ...
  Future<void> _createTransfers() async {
    ...
    for (int m = 3; m <= 8; m++) {
      ...
      await db.insert('wallet_transfers', {
        'id': _uuid.v4(),
        'source_wallet_id': vietinbankWalletId,
        'destination_wallet_id': momoWalletId,
        'amount': 6000000.0,
        'fee': 0.0,
      ...
      await db.insert('wallet_transfers', {
        'id': _uuid.v4(),
        'source_wallet_id': vietinbankWalletId,
        'destination_wallet_id': defaultCashWalletId,
        'amount': 3000000.0,
        'fee': 0.0,
      ...
      if (m % 2 == 0) {
        ...
        await db.insert('wallet_transfers', {
          'id': _uuid.v4(),
          'source_wallet_id': vietinbankWalletId,
          'destination_wallet_id': binanceWalletId,
          'amount': 10000000.0,
          'fee': 0.0,
